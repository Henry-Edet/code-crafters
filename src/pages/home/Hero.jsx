...
function Hero() {
  return (
    <section className=" flex justify-center bg-transparent text-center py-[3rem] w-full ">
      <div className=" flex flex-col justify-center items-center gap-[2rem] mobile:gap-[3rem] w-[85%] ">
        <h1 className=" heroHeader w-[90%] ">
